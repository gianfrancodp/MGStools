...
NOTE: This script is not meant to be executed as is, but rather embedded within an ArcGIS toolbox! (see 'MetPetools.atbx').
...
with io.open(AttributeTable_path, 'w', encoding="utf-8") as f:
    text = json.dumps(attributes_list, ensure_ascii=False)
    f.write(text)
