...
# !!! User inputs !!!
NAME = 'TEST2' # name of the project, used to name the output files


# Change these ABSOLUTE paths with the paths to your shapefile and raster
SHAPEFILE = r'/Volumes/Dati/sample_data/TOR1/TOR1.shp'
RASTER = r'Volumes/Dati/sample_data/TOR1/TOR1.jpg'

# path where the output files will be saved 
# Make sure that the path exists and that you have write permissions
OUTDIR = r'/Volumes/Dati/sample_data/' 
